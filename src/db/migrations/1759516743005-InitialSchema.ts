...
export class InitialSchema1759516743005 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "organizations" ("organizationID" SERIAL NOT NULL, "orgName" character varying(255) NOT NULL, "isDeleted" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "ownerID" integer, CONSTRAINT "PK_10b03bd990563f8aadc4ac6b0ac" PRIMARY KEY ("organizationID"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "organizations" ADD CONSTRAINT "FK_1af2b08e895165039006b7db080" FOREIGN KEY ("ownerID") REFERENCES "users"("userID") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "organizations" DROP CONSTRAINT "FK_1af2b08e895165039006b7db080"`,
    );
